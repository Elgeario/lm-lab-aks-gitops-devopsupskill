...
The just type the variable name to get the contents and then add that into the below command to get your ArgoCD password:     5ij4QxeKnU4NJNWW

```
[Text.Encoding]::Utf8.GetString([Convert]::FromBase64String('**argocdpass output in here**'))
[Text.Encoding]::Utf8.GetString([Convert]::FromBase64String('NWlqNFF4ZUtuVTROSk5XVw=='))
```
...
![Argo Dashboard](./images/argo_dashboard.png) kubectl can talk to your cluster
